...
public class FAQNotFoundException extends FAQException {
    ...
    public FAQNotFoundException(String message) {
        super(FAQErrorCode.FAQ_NOT_FOUND, message);
    }
     ...
     */
    public FAQNotFoundException(Throwable cause) {
        super(FAQErrorCode.FAQ_NOT_FOUND, cause);
    }
    ...
    public FAQNotFoundException(String message, Throwable cause) {
        super(FAQErrorCode.FAQ_NOT_FOUND, message, cause);
    }
}