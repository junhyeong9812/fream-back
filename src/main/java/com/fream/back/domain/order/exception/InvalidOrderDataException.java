...
public class InvalidOrderDataException extends OrderException {
    ...
    public InvalidOrderDataException() {
        super(OrderErrorCode.INVALID_ORDER_DATA);
    }
    ...
    public InvalidOrderDataException(String message) {
        super(OrderErrorCode.INVALID_ORDER_DATA, message);
    }
    ...
    public InvalidOrderDataException(Throwable cause) {
        super(OrderErrorCode.INVALID_ORDER_DATA, cause);
    }
    ...
    public InvalidOrderDataException(String message, Throwable cause) {
        super(OrderErrorCode.INVALID_ORDER_DATA, message, cause);
    }
}