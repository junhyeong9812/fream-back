...
public class FAQException extends GlobalException {
     ...
     */
    public FAQException(ErrorCode errorCode, Throwable cause) {
     ...
     * @param cause 원인이 되는 예외
     */
    public FAQException(ErrorCode errorCode, String message, Throwable cause) {
