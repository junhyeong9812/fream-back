...
/**
 * GPT API 호출 과정에서 발생하는 예외를 처리하는 클래스
 */
public class GPTApiException extends ChatQuestionException {

    /**
     * ChatQuestionErrorCode.GPT_API_ERROR 기본 에러 코드로 예외 생성
     */
    public GPTApiException() {
        super(ChatQuestionErrorCode.GPT_API_ERROR);
    }
    ...
    public GPTApiException(String message) {
        super(ChatQuestionErrorCode.GPT_API_ERROR, message);
    }
    ...
    public GPTApiException(Throwable cause) {
        super(ChatQuestionErrorCode.GPT_API_ERROR, cause);
    }
    ...
    public GPTApiException(String message, Throwable cause) {
        super(ChatQuestionErrorCode.GPT_API_ERROR, message, cause);
    }
}