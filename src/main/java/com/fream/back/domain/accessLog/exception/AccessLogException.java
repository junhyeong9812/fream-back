...
/**
 * 접근 로그 도메인에서 발생하는 모든 예외의 기본 클래스
 * GlobalException을 상속받아 전역 예외 처리 시스템과 통합됨
 */
public class AccessLogException extends GlobalException {
     ...
     */
    public AccessLogException(ErrorCode errorCode, String message) {
     ...
     */
    public AccessLogException(ErrorCode errorCode, Throwable cause) {
     ...
     * @param cause 원인이 되는 예외
     */
    public AccessLogException(ErrorCode errorCode, String message, Throwable cause) {
