...
/**
 * 주소 서비스 관련 예외를 처리하는 클래스
 * 모든 주소 관련 예외는 이 클래스를 상속받아 구현합니다.
 */
public class AddressException extends GlobalException {
     ...
     */
    public AddressException(ErrorCode errorCode, Throwable cause) {
     ...
     * @param cause 원인이 되는 예외
     */
    public AddressException(ErrorCode errorCode, String message, Throwable cause) {
