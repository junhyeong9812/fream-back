 ...
 */
public class InvalidOrderBidDataException extends OrderException {

    /**
     * 기본 에러 코드로 예외 생성
     */
    public InvalidOrderBidDataException() {
     ...
     */
    public InvalidOrderBidDataException(String message) {
     ...
     */
    public InvalidOrderBidDataException(Throwable cause) {
     ...
     * @param cause 원인이 되는 예외
     */
    public InvalidOrderBidDataException(String message, Throwable cause) {
