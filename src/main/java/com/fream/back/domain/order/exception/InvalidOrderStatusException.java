...
public class InvalidOrderStatusException extends OrderException {
    ...
    public InvalidOrderStatusException(String message) {
        super(OrderErrorCode.INVALID_ORDER_STATUS, message);
    }
    ...
    public InvalidOrderStatusException(Throwable cause) {
        super(OrderErrorCode.INVALID_ORDER_STATUS, cause);
    }
    ...
    public InvalidOrderStatusException(String message, Throwable cause) {
        super(OrderErrorCode.INVALID_ORDER_STATUS, message, cause);
    }
}